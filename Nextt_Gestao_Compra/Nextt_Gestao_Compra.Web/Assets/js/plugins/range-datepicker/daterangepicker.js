        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button class="applyBtn" onclick="setTimeout(\'recarregarDashboard()\', 500)" disabled="disabled"></button>&nbsp;' +
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.locale = {
                ...
                toLabel: 'Para',
                weekLabel: 'S',
                customRangeLabel: 'Per&iacute;odo personalizado',
            ...
            if (typeof options.ranges === 'object') {
                ...
                for (range in this.ranges) {
                    list += '<li onclick="setTimeout(\'recarregarDashboard()\', 500)">' + range + '</li>';
                }
